...
public class Libro extends Material {
	...
	public Libro(String titulo, int año_publicacion, String autor, String ISBN) throws ISBN_NO_ACEPTADO {
	...
	public void setISBN(String iSBN) throws ISBN_NO_ACEPTADO {
		/*
		 * if (ISBN.length() < 6) { throw new ISBN_NO_ACEPTADO("ISBN No aceptado"); }
		 * else if (ISBN.length() > 6) { throw new ISBN_NO_ACEPTADO("ISBN No aceptado");
		 * } else { ISBN = iSBN; }
		 */
		this.ISBN = iSBN;
	}
